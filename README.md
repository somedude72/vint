...
Head over to the [quickstart guide](https://somedude72.github.io/vint/home#quickstart) for a step by step guide on the installation of this library. Alternatively, check out the [tutorial](https://somedude72.github.io/vint/tutorial) to see some basic usages of the features provided by vint.

Vint is inspired by and implemented similar to Python's integer object. Please refer to the [documentation page](https://somedude72.github.io/vint/home) for more information on its implementation.
