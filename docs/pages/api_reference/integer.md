...
`Integer(const std::string& num)` `(explicit)` <br>
...
int main() {
    Integer n = vint::Integer("1234567890987654321");
    n = (n++) - vint::ipow(n, 100);
